...
public class Profile_Organization_Post_Delete_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_organization_post_delete_dialog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Profile_Organization_Post_Edit.class);
        startActivity(intent);
    }
