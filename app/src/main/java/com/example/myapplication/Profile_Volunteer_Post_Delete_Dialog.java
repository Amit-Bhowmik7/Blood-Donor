...
public class Profile_Volunteer_Post_Delete_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_volunteer_post_delete_dialog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Profile_Volunteer_Post_Edit.class);
        startActivity(intent);
    }
