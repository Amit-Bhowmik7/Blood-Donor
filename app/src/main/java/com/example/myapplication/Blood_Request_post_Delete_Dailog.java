...
public class Blood_Request_post_Delete_Dailog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blood_request_post_delete_dailog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Blood_Request_Post_Edit.class);
        startActivity(intent);
    }
