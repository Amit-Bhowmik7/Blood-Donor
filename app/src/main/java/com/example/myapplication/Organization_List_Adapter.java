...
public class Organization_List_Adapter extends RecyclerView.Adapter<Organization_List_Adapter.RequestViewHolder> {
    private List<Organization_Add_Handler> requestList;

    public Organization_List_Adapter(List<Organization_Add_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Organization_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Organization_Post_Edit.class);
