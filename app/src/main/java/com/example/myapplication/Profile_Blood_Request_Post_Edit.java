...
public class Profile_Blood_Request_Post_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_blood_request_post_edit);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Profile_Blood_Request_Post_Delete_Dialog.class);
        startActivity(intent);
    }
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                Profile_Blood_Request_Post_Edit.this,
