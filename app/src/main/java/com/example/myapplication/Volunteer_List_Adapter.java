...
public class Volunteer_List_Adapter extends RecyclerView.Adapter<Volunteer_List_Adapter.RequestViewHolder>{
    private List<Volunteer_Add_Handler> requestList;

    public Volunteer_List_Adapter(List<Volunteer_Add_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Volunteer_List_Adapter.RequestViewHolder holder, int position) {
       ...
       if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Volunteer_Post_Edit.class);
