...
public class Profile_Volunteer_List_Adapter extends RecyclerView.Adapter<Profile_Volunteer_List_Adapter.RequestViewHolder>{

    private List<Volunteer_Add_Handler> requestList;

    public Profile_Volunteer_List_Adapter(List<Volunteer_Add_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Profile_Volunteer_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Profile_Volunteer_Post_Edit.class);
