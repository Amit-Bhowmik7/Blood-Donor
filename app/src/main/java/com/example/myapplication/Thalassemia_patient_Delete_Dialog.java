...
public class Thalassemia_patient_Delete_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thalassemia_patient_delete_dialog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Thalassemia_Patient_Edit.class);
        startActivity(intent);
    }
