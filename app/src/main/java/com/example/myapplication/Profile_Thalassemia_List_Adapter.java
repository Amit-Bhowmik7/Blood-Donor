...
public class Profile_Thalassemia_List_Adapter extends RecyclerView.Adapter<Profile_Thalassemia_List_Adapter.RequestViewHolder>{

    private List<Thalassemia_Patient_Handler> requestList;

    public Profile_Thalassemia_List_Adapter(List<Thalassemia_Patient_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Profile_Thalassemia_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Profile_Thalassemia_Post_Edit.class);
