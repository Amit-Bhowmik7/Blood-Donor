...
public class Profile_Thalassemia_Post_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_thalassemia_post_edit);
                                ...
                                if (!originalmobileNumber.equals(mobileNumber)) {
                                    thalassemiaDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            if (snapshot.hasChild(mobileNumber)) {
                                                ...
                                                thalassemiaDatabase.child(originalmobileNumber).get()
                                                        .addOnSuccessListener(dataSnapshot -> {
                                                            ...
                                                            Toast.makeText(Profile_Thalassemia_Post_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        }
                                        ...
                                        public void onCancelled(@NonNull DatabaseError error) {
                                            Toast.makeText(Profile_Thalassemia_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Profile_Thalassemia_Post_Delete_Dialog.class);
