...
public class Admin_Facts_Post_Delete_Dialog extends AppCompatActivity {
    ...
    private static final String PREFERENCES = "factsList";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_facts_post_delete_dialog);

        // Initialize Firebase Database
        volunteerRequestPostDatabase = FirebaseDatabase.getInstance().getReference("FactsList");
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Admin_Facts_Post_Edit.class);
        startActivity(intent);
    }
    ...
    private void deletePost() {
        ...
        String requestId = factsRequestPost.getString("f_requestId", null);

        if (requestId != null) {
            // Remove user data from Firebase
            volunteerRequestPostDatabase.child(requestId).removeValue().addOnCompleteListener(task -> {
