...
public class Volunteer_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volunteer_post_edit);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Volunteer_Post_Delete_Dialog.class);
                            ...
                            if (!originalmobileNumber.equals(mobileNumberInput)) {
                                volunteerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        if (snapshot.hasChild(mobileNumberInput)) {
                                            ...
                                            volunteerDatabase.child(originalmobileNumber).get()
                                                    .addOnSuccessListener(dataSnapshot -> {
                                                        ...
                                                        Toast.makeText(Volunteer_Post_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                    });
                                        }
                                    }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        Toast.makeText(Volunteer_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
