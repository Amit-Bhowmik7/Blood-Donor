...
public class Admin_Blood_Request_List extends AppCompatActivity {
    private RecyclerView recyclerView;
    private Spinner districtsSpinner;
    private Admin_Blood_Request_List_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Admin_Blood_Request_List_Adapter(requestList);
    ...
    private void fetchRequests() {
        requestDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Admin_Blood_Request_List.this, "Failed to load data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
