...
public class Profile_Thalassemia_List extends AppCompatActivity {
    String[] districts;
    private Spinner districtsSpinner;
    private RecyclerView recyclerView;
    private Profile_Thalassemia_List_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_thalassemia_list);
        ...
        adapter = new Profile_Thalassemia_List_Adapter(requestList);
    ...
    private void fetchRequests() {
        ...
        requestDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Profile_Thalassemia_List.this, "Failed to load data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
