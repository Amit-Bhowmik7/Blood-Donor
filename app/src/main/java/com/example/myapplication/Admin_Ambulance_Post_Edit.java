...
public class Admin_Ambulance_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ambulance_post_edit);
                                ...
                                if (!originalmobileNumber.equals(mobileNumber)) {
                                    ambulanceDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            if (snapshot.hasChild(mobileNumber)) {
                                                ...
                                                ambulanceDatabase.child(originalmobileNumber).get()
                                                        .addOnSuccessListener(dataSnapshot -> {
                                                            ...
                                                            Toast.makeText(Admin_Ambulance_Post_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        }
                                        ...
                                        public void onCancelled(@NonNull DatabaseError error) {
                                            Toast.makeText(Admin_Ambulance_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Admin_Ambulance_Post_Delete_Dialog.class);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Admin_Ambulance_List.class);
        startActivity(intent);
    }
