...
public class Ambulance_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance_post_edit);
                                ...
                                if (!originalmobileNumber.equals(mobileNumber)) {
                                    ambulanceDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            if (snapshot.hasChild(mobileNumber)) {
                                                ...
                                                ambulanceDatabase.child(originalmobileNumber).get()
                                                        .addOnSuccessListener(dataSnapshot -> {
                                                            ...
                                                            Toast.makeText(Ambulance_Post_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        }
                                        ...
                                        public void onCancelled(@NonNull DatabaseError error) {
                                            Toast.makeText(Ambulance_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Ambulance_Post_Delete_Dialog.class);
