...
public class Admin_Blood_Request_Post_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_blood_request_post_edit);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Admin_Blood_Request_List.class);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Admin_Blood_Request_Post_Delete_Dialog.class);
        startActivity(intent);
    }
                                        ...
                                        if (!hospital_LocationInput.isEmpty()) {
                                            ...
                                            if (!mobileNumberInput.isEmpty() && isValidBangladeshiPhoneNumber(mobileNumberInput)) {
                                                ...
                                                if (requestId != null) {
                                                    ...
                                                    Intent intent = new Intent(getApplicationContext(), Admin_Blood_Request_Post_Edit.class);
                                                    startActivity(intent);
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                Admin_Blood_Request_Post_Edit.this,
