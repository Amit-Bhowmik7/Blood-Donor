...
public class Admin_Thalassemia_Patient_Delete_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_thalassemia_patient_delete_dialog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Admin_Thalassemia_Patient_Edit.class);
        startActivity(intent);
    }
