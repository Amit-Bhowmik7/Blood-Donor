...
public class Profile_Blood_Request_List_Adapter extends RecyclerView.Adapter<Profile_Blood_Request_List_Adapter.RequestViewHolder> {

    private List<Blood_Request_Handler> requestList;

    public Profile_Blood_Request_List_Adapter(List<Blood_Request_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Profile_Blood_Request_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Profile_Blood_Request_Post_Edit.class);
