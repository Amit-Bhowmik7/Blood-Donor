...
public class Admin_Thalassemia_Patient_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_thalassemia_patient_edit);
                                ...
                                if (!originalmobileNumber.equals(mobileNumber)) {
                                    thalassemiaDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            if (snapshot.hasChild(mobileNumber)) {
                                                ...
                                                thalassemiaDatabase.child(originalmobileNumber).get()
                                                        .addOnSuccessListener(dataSnapshot -> {
                                                            ...
                                                            Toast.makeText(Admin_Thalassemia_Patient_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        }
                                        ...
                                        public void onCancelled(@NonNull DatabaseError error) {
                                            Toast.makeText(Admin_Thalassemia_Patient_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Admin_Thalassemia_Patient_Delete_Dialog.class);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Admin_Thalassemia_Patient_List.class);
        startActivity(intent);
    }
