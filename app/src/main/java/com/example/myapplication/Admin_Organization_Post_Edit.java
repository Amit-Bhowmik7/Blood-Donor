...
public class Admin_Organization_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_organization_post_edit);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Admin_Organization_Post_Delete_Dialog.class);
                            ...
                            if (!originalmobileNumber.equals(mobileNumberInput)) {
                                organizationDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        if (snapshot.hasChild(mobileNumberInput)) {
                                            ...
                                            organizationDatabase.child(originalmobileNumber).get()
                                                    .addOnSuccessListener(dataSnapshot -> {
                                                        ...
                                                        Toast.makeText(Admin_Organization_Post_Edit.this, "Profile updated successfully!", Toast.LENGTH_SHORT).show();
                                                    });
                                        }
                                    }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        Toast.makeText(Admin_Organization_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Admin_Organization_List.class);
        startActivity(intent);
    }
