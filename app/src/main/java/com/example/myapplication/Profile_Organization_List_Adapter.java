...
public class Profile_Organization_List_Adapter extends RecyclerView.Adapter<Profile_Organization_List_Adapter.RequestViewHolder> {

    private List<Organization_Add_Handler> requestList;

    public Profile_Organization_List_Adapter(List<Organization_Add_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Profile_Organization_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Profile_Organization_Post_Edit.class);
