...
public class Admin_Blood_Request_List_Adapter extends RecyclerView.Adapter<Admin_Blood_Request_List_Adapter.RequestViewHolder> {

    private List<Blood_Request_Handler> requestList;

    public Admin_Blood_Request_List_Adapter(List<Blood_Request_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Admin_Blood_Request_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getRequestId() !=null) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Admin_Blood_Request_Post_Edit.class);
