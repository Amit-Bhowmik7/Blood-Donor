...
public class Admin_Volunter_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_volunter_post_edit);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Admin_Volunteer_Post_Delete_Dialog.class);
                            ...
                            if (!originalmobileNumber.equals(mobileNumberInput)) {
                                volunteerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        if (snapshot.hasChild(mobileNumberInput)) {
                                            ...
                                            volunteerDatabase.child(originalmobileNumber).get()
                                                    .addOnSuccessListener(dataSnapshot -> {
                                                        ...
                                                        Toast.makeText(Admin_Volunter_Post_Edit.this, "Post updated successfully!", Toast.LENGTH_SHORT).show();
                                                    });
                                        }
                                    }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        Toast.makeText(Admin_Volunter_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
