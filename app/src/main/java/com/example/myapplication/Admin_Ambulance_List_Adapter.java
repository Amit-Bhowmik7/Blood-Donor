...
public class Admin_Ambulance_List_Adapter extends RecyclerView.Adapter<Admin_Ambulance_List_Adapter.RequestViewHolder> {

    private List<Ambulance_Add_Handler> requestList;

    public Admin_Ambulance_List_Adapter(List<Ambulance_Add_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Admin_Ambulance_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getMobileNumber() !=null) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Admin_Ambulance_Post_Edit.class);
