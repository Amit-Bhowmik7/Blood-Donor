...
public class Ambulance_List_Adapter extends RecyclerView.Adapter<Ambulance_List_Adapter.RequestViewHolder> {
    private List<Ambulance_Add_Handler> requestList;

    public Ambulance_List_Adapter(List<Ambulance_Add_Handler> requestList) {
    ...
    public void onBindViewHolder(@NonNull RequestViewHolder holder, int position) {
        ...
        if (request.getAccountNumber().equals(signInAccountNumber)) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Ambulance_Post_Edit.class);
