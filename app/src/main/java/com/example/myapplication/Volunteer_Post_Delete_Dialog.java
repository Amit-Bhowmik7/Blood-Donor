...
public class Volunteer_Post_Delete_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volunteer_post_delete_dialog);
    ...
    private void backButton() {
        Intent intent = new Intent(getApplicationContext(), Volunteer_Post_Edit.class);
        startActivity(intent);
    }
