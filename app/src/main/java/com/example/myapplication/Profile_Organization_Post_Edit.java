...
public class Profile_Organization_Post_Edit extends AppCompatActivity {
    String[] districts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_organization_post_edit);
    ...
    private void deletePost() {
        Intent intent = new Intent(getApplicationContext(), Profile_Organization_Post_Delete_Dialog.class);
                            ...
                            if (!originalmobileNumber.equals(mobileNumberInput)) {
                                organizationDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        if (snapshot.hasChild(mobileNumberInput)) {
                                            ...
                                            organizationDatabase.child(originalmobileNumber).get()
                                                    .addOnSuccessListener(dataSnapshot -> {
                                                        ...
                                                        Toast.makeText(Profile_Organization_Post_Edit.this, "Profile updated successfully!", Toast.LENGTH_SHORT).show();
                                                    });
                                        }
                                    }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        Toast.makeText(Profile_Organization_Post_Edit.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
