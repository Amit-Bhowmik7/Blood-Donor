...
public class Admin_Thalassemia_Patient_List_Adapter extends RecyclerView.Adapter<Admin_Thalassemia_Patient_List_Adapter.RequestViewHolder> {

    private List<Thalassemia_Patient_Handler> requestList;

    public Admin_Thalassemia_Patient_List_Adapter(List<Thalassemia_Patient_Handler> requestList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Admin_Thalassemia_Patient_List_Adapter.RequestViewHolder holder, int position) {
        ...
        if (request.getMobileNumber() !=null) {
            holder.editButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(v.getContext(), Admin_Thalassemia_Patient_Edit.class);
